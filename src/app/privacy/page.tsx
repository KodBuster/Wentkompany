      ...
      <div className="wrap max-w-[75ch]">
        ...
        <div className="muted flex flex-col gap-5 text-[0.95rem]">
          ...
          <div>
            ...
            <p className="mt-3">
              Если вы прикладываете к заявке чертёж, эскиз или фотографию, файл передаётся
              менеджеру вместе с заявкой и на сервере сайта не сохраняется. Файл используется
              только для подготовки расчёта и не публикуется.
            </p>
          </div>
          <div>
